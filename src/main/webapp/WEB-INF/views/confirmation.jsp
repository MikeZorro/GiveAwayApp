...
<div class="summary">
    ...
    <form:form action="/donate/confirmation" method="post" modelAttribute="donation">
                        <h4>Oddajesz:</h4>
                        <ul>
                            <li>
                                <span class="icon icon-bag"></span>
                                <span class="summary--text"
                                >${donation.quantity} worki <c:forEach var="category" items="${categoryList}">${category.name}, </c:forEach></span
                                >
                            </li>
